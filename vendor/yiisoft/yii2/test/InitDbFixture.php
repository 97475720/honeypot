 ...
 *
 * You should normally use InitDbFixture to prepare a skeleton Article database.
 * Other DB fixtures will then add specific tables and data to this database.
 *
 * For more details and usage information on InitDbFixture, see the [guide article on fixtures](guide:Article-fixtures).
 *
