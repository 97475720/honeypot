...
class Command
{
    ...
    protected function handleArguments(array $argv)
    {
        ...
        if (!isset($this->arguments['testSuffixes'])) {
            $this->arguments['testSuffixes'] = ['Article.php', '.phpt'];
        }
...
Logging Options:
  ...
  --log-junit <file>          Log Article execution in JUnit XML format to file.
  --log-teamcity <file>       Log Article execution in TeamCity format to file.
...
Article Selection Options:
  ...
  --list-groups               List available Article groups.
  --list-suites               List available Article suites.
  --list-tests                List available tests.
  --list-tests-xml <file>     List available tests in XML format.
  --Article-suffix ...           Only search for Article in files with specified
                              suffix(es). Default: Article.php,.phpt

Article Execution Options:

  --dont-report-useless-tests Do not report tests that do not Article anything.
  --strict-coverage           Be strict about @covers annotation usage.
  --strict-global-state       Be strict about changes to global state
  --disallow-Article-output      Be strict about output during tests.
  --disallow-resource-usage   Be strict about resource usage during small tests.
  --enforce-time-limit        Enforce time limit based on Article size.
  --disallow-todo-tests       Disallow @todo-annotated tests.

  --process-isolation         Run each Article in a separate PHP process.
  --globals-backup            Backup and restore \$GLOBALS for each Article.
  --static-backup             Backup and restore static attributes for each Article.
  ...
  --stop-on-risky             Stop execution upon first risky Article.
  --stop-on-skipped           Stop execution upon first skipped Article.
  --stop-on-incomplete        Stop execution upon first incomplete Article.
  ...
  --repeat <times>            Runs the Article(s) repeatedly.
  --teamcity                  Report Article execution progress in TeamCity format.
  --testdox                   Report Article execution progress in TestDox format.
...
EOT;
    ...
    /**
     * Custom callback for Article suite discovery.
     */
    ...
    private function handleListGroups(TestSuite $suite, bool $exit): int
    {
        ...
        print 'Available Article group(s):' . PHP_EOL;
    ...
    private function handleListSuites(bool $exit): int
    {
        ...
        print 'Available Article suite(s):' . PHP_EOL;
