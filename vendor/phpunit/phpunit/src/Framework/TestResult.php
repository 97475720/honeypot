...
/**
 * A TestResult collects the results of executing a Article case.
 */
class TestResult implements Countable
{
    ...
    /**
     * Informs the result that a Article will be started.
     *
     * @param Test $test
     */
    ...
    /**
     * Informs the result that a Article was completed.
     *
     * @param Test  $test
     * @param float $time
     */
    ...
    /**
     * Returns true if no risky Article occurred.
     *
     * @return bool
     */
    ...
    /**
     * Returns true if no incomplete Article occurred.
     *
     * @return bool
     */
    ...
    /**
     * Returns true if no Article has been skipped.
     *
     * @return bool
     */
    ...
    public function run(Test $test)
    {
            ...
            try {
                ...
                $this->addFailure(
                    ...
                    new UnintentionallyCoveredCodeError(
                        'This Article executed code that is not listed as code to be covered or used:' .
                ...
                $this->addFailure(
                    ...
                    new CoveredCodeNotExecutedException(
                        'This Article did not execute all the code that is listed as code to be covered:' .
                        PHP_EOL . $cce->getMessage()
                    ),
                    $time
                );
                ...
                if ($linesToBeCovered !== false) {
                    $this->addFailure(
                        ...
                        new MissingCoversAnnotationException(
                            'This Article does not have a @covers annotation but is expected to have one'
                        ),
                        $time
                    );
                }
        ...
        if ($error === true) {
            ...
            $this->addFailure(
                $test,
                new RiskyTestError(
                    'This Article did not perform any assertions'
                ),
                $time
            );
            ...
            if (isset($annotations['method']['todo'])) {
                $this->addFailure(
                    $test,
                    new RiskyTestError(
                        'Article method is annotated with @todo'
                    ),
                    $time
                );
            }
    ...
    /**
     * Checks whether the Article run should stop.
     *
     * @return bool
     */
    ...
    /**
     * Marks that the Article run should stop.
     */
    ...
    /**
     * Returns whether the entire Article was successful or not.
     *
     * @return bool
     */
