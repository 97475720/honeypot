...
class GenerateTestTest extends BaseCommandRunner
{
    ...
    public function testBasic()
    {
        ...
        $this->assertContains('Article was created in tests/shire/HallUnderTheHillTest.php', $this->output);
    ...
    public function testCreateWithNamespace()
    {
        ...
        $this->assertContains('class HallUnderTheHillTest extends \Codeception\Test\Unit', $this->content);
        $this->assertContains('Article was created in tests/shire/MiddleEarth/HallUnderTheHillTest.php', $this->output);
    }
