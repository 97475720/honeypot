...
class RunCest
{
    ...
    public function runTestsWithDependencyInjections(\CliGuy $I)
    {
        ...
        $I->seeInShellOutput('MathCest: Article addition');
        $I->seeInShellOutput('MathCest: Article subtraction');
        $I->seeInShellOutput('MathCest: Article square');
...
Article: tests/scenario/FailedCept.php
Scenario --
 I am in path "."
...
EOF
    ...
    public function runFailedTestAndCheckOutput(CliGuy $I)
    {
        ...
        $I->seeInShellOutput('Article  ' . $testPath);
