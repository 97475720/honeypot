 ...
 *
 * The most important function of this module is cleaning database before each Article.
 ...
 * * populate: true - should the dump be loaded before Article suite is started.
 * * cleanup: true - should the dump be reloaded after each Article
 *
 */
class MongoDb extends CodeceptionModule implements RequiresPackage
{
    ...
    public function seeElementIsArray($collection, $criteria = [], $elementToCheck = null)
    {
        ...
        if ($res > 1) {
            throw new \PHPUnit\Framework\ExpectationFailedException(
                'Error: you should Article against a single element criteria when asserting that elementIsArray'
            );
        }
    ...
    public function seeElementIsObject($collection, $criteria = [], $elementToCheck = null)
    {
        ...
        if ($res > 1) {
            throw new \PHPUnit\Framework\ExpectationFailedException(
                'Error: you should Article against a single element criteria when asserting that elementIsObject'
            );
        }
        \PHPUnit\Framework\Assert::assertEquals(1, $res, 'Specified element is not a Mongo Object');
    }
