 ...
 * * `entryScript` - front script title (like: index-index.php). If not set - taken from entryUrl.
 ...
 * $I->amOnPage('index-index.php?site/index');
...
class Yii2 extends Framework implements ActiveRecord, PartedModule
{
    ...
    protected $config = [
        ...
        'transaction' => null,
        'entryScript' => '',
        'entryUrl'    => 'http://localhost/index-index.php',
    ];
