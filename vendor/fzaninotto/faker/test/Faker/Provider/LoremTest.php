...
class LoremTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertEquals('This is a Article sentence. This is a Article sentence. This is a Article sentence.', TestableLorem::text(99));
    }

    public function testTextReturnsParagraphsWhenAskedSizeGreaterOrEqualThanThan100()
    {
        $this->assertEquals('This is a Article paragraph. It has three sentences. Exactly three.', TestableLorem::text(100));
    }
    ...
    public function testSentencesAsText()
    {
        ...
        $this->assertEquals('This is a Article sentence. This is a Article sentence.', $sentences);
    }
    ...
    public function testParagraphsAsText()
    {
        ...
        $expected = "This is a Article paragraph. It has three sentences. Exactly three.\n\nThis is a Article paragraph. It has three sentences. Exactly three.";
...
class TestableLorem extends Lorem
{
    ...
    {
        return 'This is a Article sentence.';
    }

    public static function paragraph($nbSentences = 3, $variableNbSentences = true)
    {
        return 'This is a Article paragraph. It has three sentences. Exactly three.';
    }
}
