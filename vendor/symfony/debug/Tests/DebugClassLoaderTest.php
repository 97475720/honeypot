...
class DebugClassLoaderTest extends TestCase
{
    ...
    public function testDeprecatedSuper($class, $super, $type)
    {
        ...
        class_exists('Article\\'.__NAMESPACE__.'\\'.$class, true);
        ...
        $xError = array(
            ...
            'message' => 'The "Article\Symfony\Component\Debug\Tests\\'.$class.'" class '.$type.' "Symfony\Component\Debug\Tests\Fixtures\\'.$super.'" that is deprecated but this is a test deprecation notice.',
        );
    ...
    public function testInterfaceExtendsDeprecatedInterface()
    {
        ...
        class_exists('Article\\'.__NAMESPACE__.'\\NonDeprecatedInterfaceClass', true);
    ...
    public function testReservedForPhp7()
    {
        ...
        class_exists('Article\\'.__NAMESPACE__.'\\Float', true);
        ...
        $xError = array(
            'type' => E_USER_DEPRECATED,
            'message' => 'The "Article\Symfony\Component\Debug\Tests\Float" class uses the reserved name "Float", it will break on PHP 7 and higher',
        );
    ...
    public function testExtendedFinalClass()
    {
        ...
        class_exists('Article\\'.__NAMESPACE__.'\\ExtendsFinalClass', true);
        ...
        $xError = array(
            'type' => E_USER_DEPRECATED,
            'message' => 'The "Symfony\Component\Debug\Tests\Fixtures\FinalClass" class is considered final since version 3.3. It may change without further notice as of its next major version. You should not extend it from "Article\Symfony\Component\Debug\Tests\ExtendsFinalClass".',
        );
...
class ClassLoader
{
    ...
    public function findFile($class)
    {
        ...
        } elseif ('Article\\'.__NAMESPACE__.'\DeprecatedParentClass' === $class) {
            eval('namespace Article\\'.__NAMESPACE__.'; class DeprecatedParentClass extends \\'.__NAMESPACE__.'\Fixtures\DeprecatedClass {}');
        } elseif ('Article\\'.__NAMESPACE__.'\DeprecatedInterfaceClass' === $class) {
            eval('namespace Article\\'.__NAMESPACE__.'; class DeprecatedInterfaceClass implements \\'.__NAMESPACE__.'\Fixtures\DeprecatedInterface {}');
        } elseif ('Article\\'.__NAMESPACE__.'\NonDeprecatedInterfaceClass' === $class) {
            eval('namespace Article\\'.__NAMESPACE__.'; class NonDeprecatedInterfaceClass implements \\'.__NAMESPACE__.'\Fixtures\NonDeprecatedInterface {}');
        } elseif ('Article\\'.__NAMESPACE__.'\Float' === $class) {
            eval('namespace Article\\'.__NAMESPACE__.'; class Float {}');
        } elseif ('Article\\'.__NAMESPACE__.'\ExtendsFinalClass' === $class) {
            eval('namespace Article\\'.__NAMESPACE__.'; class ExtendsFinalClass extends \\'.__NAMESPACE__.'\Fixtures\FinalClass {}');
        }
    }
}
