...
<head>
	...
	<script type="text/javascript" src="/lplive/Public/JS/login.js"></script>
</head>
<body>
	<div id="index">
		...
		<div id="header">
			...
			<div id="header_top">
				...
				<div class="header_inline">
					<span>
						<a class="header_login" href="<?php echo U('Login/login');?>">登录</a>
					</span>	
					<span >
						<a class="header_sign" href="<?php echo U('Login/sign');?>">注册</a>
					</span>
				</div>
			...
			<div id="header_content">
				...
				<div class="content_nav">
					...
					<div class="nav_box">
						...
						<a href="<?php echo U('Index/index');?>" class="nav_logo"><img src="/lplive/Public/IMG/logo.png"></a>		
		...
		<div id="sign_model">
			...
			<div id="sign_form">
				<form>
					<div class="input_box">
						<input type="text" class="sign_unum" placeholder="账号：请输入手机号码或邮箱"/>
						<p class="sign_unum_tips"></p>
					</div>
					<div class="input_box">
						<input type="password" class="sign_upwd" maxlength="24" placeholder="密码：请输入6-24位的数字或字母"/>
						<p class="sign_upwd_tips"></p>
					</div>	
					<div class="input_box">
						<input type="password" class="sign_upwd1" maxlength="24" placeholder="确认密码：请再次输入密码"/>
						<p class="sign_upwd1_tips"></p>
					</div>
					<div class="input_box">
						<div class='code_input'>
						<input type="text" class="sign_code" maxlength="4" placeholder="请输入验证码"/>
						<p class="sign_code_tips"></p>
						</div>
